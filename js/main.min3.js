...
var _lang = {
	zh1: {
		title: "全民寻找房祖名",
		help_txt: "1分钟之内找出房祖名15次以上,即可获得开锁和过关密码,赶紧开始吧",
		score: "得分：",
		btn_pause: "暂停",
		btn_start: "开始游戏",
		btn_reTry: "再来一次",
		...
		btn_resume: "继续游戏",
		loading: "加载中...",
		lv_txt: ["没有完成任务,重新开始闯关吧!","完成任务啦,第一个密码数字是5,回到公众号,回复\"我是大猪头\",获取第二关的地址继续闯关吧!"],
		share_txt1: "我闯过",
		share_txt2: "关，击败",
		share_txt3: "%的人，我是【",
		share_txt4: "】，不服来战！",
	...
	zh: {
		...
		btn_resume: "继续游戏",
		loading: "加载中...",
		lv_txt: ["没有完成任务,重新开始闯关吧!","完成任务啦,第一个密码数字是5,回到公众号,回复\"我是大猪头\",获取第二关的地址吧!"],
		share_txt1: "【找妹子】我在",
		share_txt2: "只袜子中找到",
		share_txt3: "个妹子，我是【",
		share_txt4: "】，不服来战！",
